  ...
  return (
    <section className="mb-8">
      ...
      <div className="text-base text-muted-foreground mb-8 max-w-2xl">
        <p className="mb-4">
          I study Computer Science at the University of Waterloo. Currently, I am a software engineering intern at Faire. Previously, I was a software developer at Cineplex Digital Media.
        </p>
        <p>
