            ...
            <article className="max-w-4xl mx-auto px-6 py-0 md:px-12">
                <div className="prose prose-neutral dark:prose-invert max-w-none">
                    <section className="space-y-4">
                        ...
                        <figure className="relative flex justify-center overflow-hidden rounded-2xl border border-black/5 shadow-sm">
                            <img
                        ...
                        <h2 className="text-lg font-medium text-foreground">Shot Detection</h2>
                        ...
                        <h2 className="text-lg font-medium text-foreground">Object Detection</h2>
                        <figure className="flex flex-col items-center">
                        ...
                        <h2 className="text-lg font-medium text-foreground">Semantic Analysis & Visual Features</h2>
                        <p className="text-base text-muted-foreground leading-relaxed">
                        ...
                        <h2 className="text-lg font-medium text-foreground">Web Visualization Tool</h2>
                        <figure className="flex flex-col items-center">
                        ...
                        <h2 className="text-lg font-medium text-foreground">The CLI</h2>
                        <figure className="flex flex-col items-center">
                            <div className="relative flex justify-center overflow-hidden rounded-2xl border border-black/5 shadow-sm max-w-[80%]">
                                <img
...
python src/pipeline.py \\
  ...
  --setting-label "highway"`}
                        ...
                        <h2 className="text-lg font-medium text-foreground">Results & Limitations</h2>
                        <p className="text-base text-muted-foreground leading-relaxed">
