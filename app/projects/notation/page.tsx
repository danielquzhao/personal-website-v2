...
export default function NotationPage() {
            ...
            <div className="max-w-4xl mx-auto px-6 py-12 md:px-12 md:py-0">
                <div className="prose prose-neutral dark:prose-invert max-w-none">
                    <div className="space-y-0">
                        ...
                        <h2 className="text-lg font-medium m-0 text-foreground pt-8">Content Extraction Pipeline</h2>
                        <p className="text-base text-muted-foreground leading-relaxed m-0">
  ...
  when /image/
    ...
    raise "Unsupported file type"
                        ...
                        <h2 className="text-lg font-medium m-0 text-foreground pt-8">LaTeX Compilation</h2>
                        <p className="text-base text-muted-foreground leading-relaxed m-0">
                        ...
                        <h2 className="text-lg font-medium m-0 text-foreground pt-8">Frontend Experience</h2>
                        <p className="text-base text-muted-foreground leading-relaxed m-0">
                        ...
                        <h2 className="text-lg font-medium m-0 text-foreground pt-8">Deployment</h2>
                        <p className="text-base text-muted-foreground leading-relaxed m-0">
                        ...
                        <h2 className="text-lg font-medium m-0 text-foreground pt-8">Technical Decisions</h2>
                        <p className="text-base text-muted-foreground leading-relaxed m-0">
